...
public class MainConfig extends PathableConfig {
    ...
    public static final ConfigPath<Boolean> LAN_ENABLE = Paths.booleanPath("server.lan.enable", false);
    public static final ConfigPath<Integer> LAN_PORT = Paths.integerPath("server.lan.port", 25565);
