package me.hsgamer.flexgames.config;

import me.hsgamer.flexgames.FlexGames;
...
public class MainConfig extends PathableConfig {
    ...
    public static final ConfigPath<String> BRAND_NAME = Paths.stringPath("server.brand-name", FlexGames.class.getSimpleName());
