...
public final class EvokerMob extends ArenaMob {
    public EvokerMob(Arena arena) {
        super(EntityType.EVOKER, arena);
        addAIGroup(
                    ...
                    scheduler().scheduleTask(() -> {
                        ...
                        for (int i = 0; i < random.nextInt(1, 3); i++) {
                            ...
                            silverfish.addAIGroup(
                                    ...
                                    List.of(new ClosestEntityTarget(silverfish, 32, Player.class::isInstance))
                            );
